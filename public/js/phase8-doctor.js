(()=>{
  ...
  function showNotice({title='Hospital Notification',kicker='WeCare Medical Center',message='',level='normal',icon='i',meta=[],primaryText='Acknowledge',onPrimary=null,secondaryText='',onSecondary=null,lock=false}){
    if(!notice)return;
  ...
  async function renderSecurity(){
    document.getElementById('pageTitle').textContent='Security Inbox';
    document.getElementById('pageSubtitle').textContent='View messages addressed to you and contact hospital administration. You cannot self-approve security incidents.';
  ...
  document.getElementById('securityCenterButton')?.addEventListener('click',renderSecurity);
  document.getElementById('notificationButton')?.addEventListener('click',renderSecurity);
